				...
				<?php  
					...
					if($_FILES){
						...
						if(!empty($_FILES['image']['name'])) {
							...
							$sql = "UPDATE usuarios SET name = '$name', gender = '$gender', image = '$image', color = '$color' WHERE id = $id";
						} else {
							$sql = "UPDATE usuarios SET name = '$name', gender = '$gender', color = '$color' WHERE id = $id";
						}
